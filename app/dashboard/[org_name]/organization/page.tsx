...
import StudentGrowth from "@/app/component/dashboard_students__growth";
import UpcomingEvents from "@/app/component/dashboard_student_upcoming_event";
...
export default function Dashboard() {
  ...
  const openCourse = () => {
    router.push(`/dashboard/${params.org_name}/community`);
  };
  return (
    <>
