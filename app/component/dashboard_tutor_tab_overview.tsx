  ...
  return (
    <div>
      <div className="dashboard_content_mainbox">
        ...
        <div className="bg-shadyColor-0 p-[16px]">
          <h1 className="font-semibold text-[14px] text-textSlightDark-0">
            Quick Action
          </h1>
          <div className="grid grid-cols-2 gap-[10px] my-4">
            <div
              className="h-[72px] bg-boldShadyColor-0 flex justify-center items-center flex-col gap-1 cursor-pointer"
          ...
          <div className="grid grid-cols-3 justify-around bg-boldShadyColor-0 my-4 p-[12px]">
          ...
          <button
            className="h-[36px] bg-boldShadyColor-0 text-primaryColors-0 w-full text-[12px]"
        ...
        <div className="my-5">
         <div>
          ...
          <div>
            {activities.length == 0 ? (
              <div className="text-center text-nearTextColors-0">No activities yet</div>
            ) : (
              <div>
                  ...
                  <div key={i}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <p className="font-semibold text-textSlightDark-0 text-[13px] line-clamp-1">
                          {a.message}
                        </p>
                      </div>
