...
export default function DashboardAdminActivities() {
  const { t } = useI18n();
        ...
        <div className="mt-[20px] flex flex-col gap-3">
            <div className="flex gap-[12px] items-start">
                ...
                <div className="flex flex-col gap-1">
                    <h1 className="text-textSlightDark-0 text-[14px] font-[600]">{t("3 students completed “Biblical Foundation” quiz")}</h1>
                    <p className="flex items-center text-textGrey-0 text-[14px] gap-2"><CiClock2 /> {t("10hr ago")}</p>
                </div>
            </div>
