...
// Same fetch/shape as DashboardStudentAnnouncement — the backend endpoint
// already branches on role (student vs tutor/instructor), the tutor
// dashboard just never had a component wired up to call it.
export default function DashboardTutorAnnouncement({ backFunc }: Props) {
  const { t } = useI18n();
