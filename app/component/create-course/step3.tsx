...
export default function CourseStep3({ formData, setFormData }: Props) {
  ...
  const getDocumentUrl = (document: Document) => {
    if(document.document_preview) {
      return document.document_preview
    }
    return document.material_document
  }
                          ...
                          >
                            ...
                            {form.name === "material_description" ? (
                              ...
                              <input
                                ...
                                onChange={(e) => handleMaterialChange(e, mat.id)}
                                className="bg-transparent border-none outline-none w-full text-textSlightDark-0 font-[500] text-[16px]"
                              />
                            )}
                          </div>
                        ))}
