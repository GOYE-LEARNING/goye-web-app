    ...
    <div className="flex flex-col gap-4">
      ...
      {form.map((data, i) => {
        return (
          <div
            key={i}
            className={`border border-[#D2D5DA]/20 flex justify-between items-center w-full py-[8px] px-[12px] ${
              data.type === "file"
                ? "border-none px-0"
            ...
            >
              ...
              {data.name === "course_description" ? (
                <textarea
                  ...
                  className="border-none outline-none text-textSlightDark-0 h-[100px] font-[500] resize-none bg-transparent"
                />
              ) : data.type === "file" ? (
                ...
                <div className="relative w-full">
                  ...
                  {showDropdown && (
                    <div className="absolute top-full left-0 right-0  border border-[#D2D5DA]/10 shadow-lg z-10">
                      <DropDowns
                        value={courseLevel}
                        onChange={() => {}}
                        countries={levels.map((level, i) => {
                          return (
                            <div
                              ...
                              className="flex justify-between items-center w-full p-3 hover:bg-primaryColors-0 cursor-pointer"
                            >
                              <div
                                className={
                                  courseLevel === level
