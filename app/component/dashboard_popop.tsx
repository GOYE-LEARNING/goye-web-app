    ...
    <>
      ...
      >
        <motion.div
          ...
          className="w-[400px] p-[40px] rounded-[8px] flex justify-center items-center flex-col gap-5 bg-secondaryColors-0 text-center"
        >
          <FaCheckCircle size={80} color="#30A46F" />
          <h1 className="text-[40px] text-white font-[500]">
            {header}
          </h1>
